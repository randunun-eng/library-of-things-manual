...
## 1. What is the Library of Things (LOT)?
...
*   **Facilities:**
    ...
    *   IoT devices.
    *   RC hobby tools.
    *   Off-grid backup power (uninterrupted operation).

### Mobile LOT (Future Phase)
*   Visits schools, universities, and communities.
...
### 🛩️ Level 4 – Innovator
*   **Access:** Drones, 3D printers, Rare or high-demand tools.
...
*   **Security:** Deposit or NIC retention may apply only when required.
*   **Process:** Item condition is logged at handover.

### Returns
*   Must be returned on or before due date.
...
### Security Deposit
*   Refundable.
*   Based on item risk & value.
*   Reduced or waived for high-trust members.

### NIC Retention
*   Used only in special cases.
*   Logged, secured, and returned immediately after return.

### Insurance & Recovery
*   LOT may self-insure items through deposits.
*   **Serious damage or loss may require:**
...
*   **Criteria:** Donation of high-value items, Expertise, Commitment to LOT vision.

### Benefits
*   Lifetime membership.
*   High starting level.
*   No deposits / NIC retention.
*   Priority access.
...
*LOT follows global best practices adapted to Sri Lankan reality.*
